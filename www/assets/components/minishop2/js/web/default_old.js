...
(function(window, document, $, undefined) {
	...
	miniShop2.Cart = {
		...
		,status: function(status) {
			...
			if(status['discount'] > 0){
				console.log('old_cost'+status['old_cost']);
				$(miniShop2.Cart.totalCost).text(miniShop2.Utils.formatPrice(status['old_cost']));
                $(miniShop2.Cart.discount).show();
                $(miniShop2.Cart.discount + ' .ms2_discount_price').text(miniShop2.Utils.formatPrice(status['total_cost']));
            }
            else{
	...
	miniShop2.Gallery2 = {
		setup: function() {
			miniShop2.Gallery2.gallery = '#msGallery2';
			miniShop2.Gallery2.mainImage = '#mainImage2';
			miniShop2.Gallery2.thumbnail = '.thumbnail';
		}
		,initialize: function() {
			miniShop2.Gallery2.setup();
			if ($(miniShop2.Gallery2.gallery).length) {
				console.log('вижу');
				miniShop2.$doc.on('click', miniShop2.Gallery2.gallery + ' ' + miniShop2.Gallery2.thumbnail, function(e) {
					var src = $(this).attr('href');
					var href = $(this).data('image');
					$(miniShop2.Gallery2.mainImage, miniShop2.Gallery2.gallery).attr('src', src).parent().attr('href', href);
					e.preventDefault();
				});

				$(miniShop2.Gallery2.thumbnail + ':first', miniShop2.Gallery2.gallery).trigger('click');
			}
		}
	};	
