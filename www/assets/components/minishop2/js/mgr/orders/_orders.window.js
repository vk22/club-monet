        ...
        return [{
            ...
            items: [{
                ...
                items: [
                    ...
                    {xtype: 'numberfield', name: 'delivery_cost', fieldLabel: _('ms2_delivery_cost'), anchor: '100%'} /// Поменял тип поля доставки на редактируемый (displayfield -> numberfield)
                ...
                items: [
                    ...
                    {xtype: 'numberfield', name: 'comment', fieldLabel: _('ms2_delivery_tracking'), anchor: '100%'} 
                ]
            }]
        }, {
            layout: 'column',
