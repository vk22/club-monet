    ...
    getOrderFields: function (config) {
        return [{
            ...
            items: [{
                ...
                layout: 'form',
                items: [
                    {xtype: 'textarea', name: 'comment', fieldLabel: _('ms2_comment'), anchor: '100%', height: 80},
                    {xtype: 'textarea', name: 'comment_manager', fieldLabel: 'Комментарий менеджера', anchor: '100%', height: 80}
                ]
            }]
        }];
    },
