...
function(e) {
    ...
    $(".zoom").magnify(), $("#phone").mask("+7 (999) 999-99-99", {
        autoclear: !1
    ...
    $("td.weight").hide(), $("[type='number']").keypress(function(e) {
        ...
        return console.log("before"), $("body").addClass("overflow-h"), $("#before-load").find("i").fadeIn().end().delay(400).fadeIn("slow"), !0
        ...
        return console.log("success"), $("body").addClass("overflow-h"), $("#before-load").find("i").fadeIn().end().delay(400).fadeIn("slow"), !0
    }
}), $(function() {
    $("nav#menu").mmenu({
        navbar: {
    ...
    $("nav.main-nav li").hover(function() {
        ...
        var e = $(this).innerWidth() / 2,
            ...
            n = t - e;
        console.log(e, t, n), $("ul", this).css("left", "0px").stop(!0, !0).slideDown(200)
    }, function() {
