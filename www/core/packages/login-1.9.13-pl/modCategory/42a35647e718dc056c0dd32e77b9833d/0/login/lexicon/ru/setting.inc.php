...
$_lang['setting_recaptcha.private_key'] = 'reCaptcha приватный ключ';
$_lang['setting_recaptcha.private_key_desc'] = 'reCaptcha приватный ключ';
$_lang['setting_recaptcha.public_key'] = 'reCaptcha публичный ключ';
$_lang['setting_recaptcha.public_key_desc'] = 'reCaptcha публичный ключ';
$_lang['setting_recaptcha.use_ssl'] = 'Использовать SSL';
$_lang['setting_recaptcha.use_ssl_desc'] = 'Использовать SSL для запросов reCaptcha. По умолчанию значение false.';
