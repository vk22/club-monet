...
$_lang['setting_office_auth_activation'] = 'Активация пользователя';
$_lang['setting_office_auth_activation_desc'] = 'Нужно ли требовать активацию пользователя через ссылку в email или код из смс';
