...
class counterProOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('counterpro_item_err_ns');
        }
...
return 'counterProOfficeItemUpdateProcessor';
