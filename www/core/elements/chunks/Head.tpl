...
<head>
    ...
    {$_modx->runSnippet('@FILE snippets/meta.php')}
    ...
    <div class="container">
        <nav class="top-nav">
            <ul>
                ...
                <li><a href="{25189 | url}" class="green">Новинки</a></li>
                <li>Мы в соцсетях:
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-1 col-sm-8 col-xs-12">
                    ...
                    <div class="basket-link">{'!msMiniCart' | snippet : [
                                                    'tpl' => 'tpl.msMiniCart'
                                                ]} </div>
                </div>                 
            </div>   
                                ...
                                <div class="row">
                                        <nav class="main-nav">
                                            ...
                                            {'pdoMenu' | snippet : [
                                                    ...
                                                    'templates' => 6,
                                                    'sortby' => 'menuindex',
                                                    'tplParentRow' => '@INLINE <li {$classes}><span href="{$link}">{$menutitle}</span><i class="fa fa-caret-down trigger"></i>{$wrapper}</li>'
                                            ]}
                                            </div>
                                        </nav> 
