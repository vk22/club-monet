 ...
 * @subpackage lexicon
 */
$_lang['recaptcha.empty_answer'] = 'Palavras de captcha incorretas. Por favor, verifique a sua resposta e tente novamente.';
$_lang['recaptcha.incorrect'] = 'O reCAPTCHA não foi inserido corretamente. Volte atrás e tente novamente. [[+error]]';
$_lang['recaptcha.mailhide_no_mcrypt'] = 'Para usar o reCAPTCHA Mailhide, precisa ter o módulo mcrypt do php instalado.';
