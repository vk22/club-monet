...
$_lang['setting_office_auth_activation'] = 'User activation';
$_lang['setting_office_auth_activation_desc'] = 'Require user activation via a link in email or a code from SMS';
