...
$_lang['setting_ms2_payment_sbrbnk_tax_type_desc'] = '<b>0</b> (без НДС), <b>1</b> (по ставке 0%), <b>2</b> (по ставке 10%), <b>3</b> (по ставке 18%), <b>4</b> (по расчётной ставке 10/110), <b>5</b> (по расчётной ставке 18/118), <b>6</b> (по ставке 20%), <b>7</b> (по расчётной ставке 20/120) - полный список в документации <a href="https://securepayments.sberbank.ru/wiki/doku.php/integration:api:rest:requests:register_cart#tax" target="_blank">API Сбербанка</a>';
...
$_lang['setting_ms2_payment_sbrbnk_debug'] = 'Включить логи';
$_lang['setting_ms2_payment_sbrbnk_debug_desc'] = 'Запись логов запросов в журнал ошибок MODX';
